  ...
  <footer class="text-white py-5 mt-auto" style="background-color: #0D6B6F">
    <div class="container">
      <div class="row g-4">
        <!-- Vintage Column -->
        <div class="col-md-3">
          <h5 class="fw-semibold mb-4">Vintage</h5>
          <ul class="list-unstyled">
            <li class="mb-3">
              <a href="#" class="text-white text-decoration-none opacity-75 hover-opacity">
                About us
              </a>
            </li>
            <li class="mb-3">
        ...
        <!-- Discover Column -->
        <div class="col-md-3">
          <h5 class="fw-semibold mb-4">Discover</h5>
          <ul class="list-unstyled">
            <li class="mb-3">
              <a href="#" class="text-white text-decoration-none opacity-75 hover-opacity">
                How it works
      ...
      <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
        ...
        <div class="d-flex gap-3 mb-3 mb-md-0">
          <a 
            href="#" 
            class="text-white d-flex align-items-center justify-content-center rounded-circle bg-white bg-opacity-10"
